...
public class GetAllItemEstoqueUseCase : IGetAllItemEstoqueUseCase
{
    ...
    public GetAllItemEstoqueUseCase(IMapper mapper, IEstoqueRepository estoqueRepository, ILogger<GetAllItemEstoqueUseCase> logger, IValidator<ItemEstoqueRequest> validator)
    {
        _mapper = mapper;
