...
public class UpdateItemEstoqueUseCase : IUpdateItemEstoqueUseCase
{
    private readonly IEstoqueRepository _estoqueRepository;
    private readonly IValidator<UpdateItemEstoqueRequest> _validator;
    private readonly ILogger<UpdateItemEstoqueUseCase> _logger;
    private readonly IMapper _mapper;
    private const string UseCaseLogPrefix = "[Update Item Estoque]";

    public UpdateItemEstoqueUseCase(IEstoqueRepository estoqueRepository, IValidator<UpdateItemEstoqueRequest> validator, ILogger<UpdateItemEstoqueUseCase> logger, IMapper mapper)
    {
    ...
    public async Task<Result> ExecuteAsync(UpdateItemEstoqueRequest request)
    {
